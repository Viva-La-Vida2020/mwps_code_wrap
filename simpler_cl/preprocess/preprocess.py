...
#     f.write("\n")
# f.close()
train_data = load_raw_data('../data/mathqa/MathQA_train.json')
dev_data = load_raw_data('../data/mathqa/MathQA_dev.json')
test_data = load_raw_data('../data/mathqa/MathQA_test.json')
train_data = transfer_num(train_data)
dev_data = transfer_num(dev_data)
test_data = transfer_num(test_data)
f = open('../data/mathqa/MathQA_train.jsonl', 'w')
for d in train_data:
    json.dump(d, f, ensure_ascii=False)
    f.write("\n")
f.close()
f = open('../data/mathqa/MathQA_dev.jsonl', 'w')
for d in dev_data:
    json.dump(d, f, ensure_ascii=False)
    f.write("\n")
f.close()
f = open('../data/mathqa/MathQA_test.jsonl', 'w')
for d in test_data:
    json.dump(d, f, ensure_ascii=False)
    f.write("\n")
f.close()