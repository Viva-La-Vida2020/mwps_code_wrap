...
from src.metrics.metrics_steps import compute_steps_result
...
class MathSolver(LightningModule):
    ...
    def validation_step(self, batch):
        ...
        pred_answer = compute_steps_result(pred, nums)
        val_correction = abs(answer - pred_answer) < 1e-3
    ...
    def test_step(self, batch):
        ...
        steps = [op[0] for op in batch["steps"]]  # Convert from [tuple(str, )] to [str, ]
        answer = batch["answer"]
        nums = [num[0] for num in batch["nums"]]
