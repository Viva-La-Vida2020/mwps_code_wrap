    ...
    def _process_sample(self, sample):
        ...
        if self.mode in ['train']:
            return {
                ...
                "num_ids": num_ids,
                "equ_ids": equ_ids,
                "holistic_view": sample["prefix"],
                "primary_view": sample["root_nodes"],
                "longest_view": sample["longest_view"],
            }
...
class MathDataModule(pl.LightningDataModule):
    ...
    def custom_collate_fn(self, batch):
        ...
        holistic_views = [item["holistic_view"] for item in batch]
        primary_views = [item["primary_view"] for item in batch]
        longest_views = [item["longest_view"] for item in batch]
        ...
        return {
            ...
            "equ_ids": equ_ids,
            "equ_pads": equ_pads,
            "holistic_views": holistic_views,
            "primary_views": primary_views,
            "longest_views": longest_views,
        }
...
if __name__ == '__main__':
    ...
    data_module = MathDataModule(
        ...
        train_file="train_simpler.jsonl",  # Ensure this file exists in `data/`
